...
export const pt: TranslationTree = {
  ...
  quiz: {
    ...
    blankRegenerate: 'Gerar lacunas novas',
    blankTooShort: 'O versículo é curto demais.',
    blankInputA11y: 'Campo lacuna {{n}}',
    orderHint: 'Recoloque cada trecho como no versículo.',
    orderSwapHint:
      'Use ▲/▼ ou toque dois blocos para trocá-los de lugar.',
    orderCheck: 'Conferir ordem',
    orderCorrect: 'Ordem certeira!',
    orderWrong: 'Ainda há diferença — conferência logo abaixo.',
    orderTooShort: 'Não deu para dividir o versículo nesse modo.',
    orderReshuffle: 'Embaralhar novamente',
    orderMoveUpA11y: 'Mover fragmento pra cima',
    orderMoveDownA11y: 'Mover fragmento pra baixo',
  },
  reference: {
    label: 'Referência',
  },
  ...
  auth: {
    ...
    supabaseEnvMissing:
      'EXPO_PUBLIC_SUPABASE_URL e EXPO_PUBLIC_SUPABASE_ANON_KEY estão ausentes ou vazias na implantação. No Vercel: Settings → Environment Variables, adicione e faça Redeploy.',
  ...
  home: {
    ...
    reviewListColRemark: 'Obs.',
    reviewListRemarkNext: 'Próx. prática\n{{date}}',
    reviewListRemarkPrev: 'Prática anterior\n{{date}}',
    reviewListRemarkFirstPractice: 'Primeira prática',
    reviewListRowA11y:
      '{{phase}}. {{ref}}. {{session}}. {{status}}. {{remark}}.',
    reviewListSessionPractice: '{{n}}ª sessão',
    reviewListTrainingDoneStatus: 'Concluído',
    reviewListTrainingPendingStatus: 'Pendente',
    sectionLongRetrain: 'Longo — retrabalhar ×7 e reagendar',
    badgeShortDay: 'Dia {{n}}',
