...
export const ko = {
  ...
  seven: {
    ...
    statusWait: '대기',
    a11yCell: '{{rep}} {{status}}',
    verifyScriptureBtn: '말씀확인',
    verifyScriptureA11y:
      '참조와 본문을 열어 암송할 내용을 확인합니다. 닫으면 다시 숨겨집니다.',
    verifyVerseListenBtn: '말씀듣기',
    verifyVerseListenPause: '일시정지',
    verifyVerseListenResume: '이어듣기',
    verifyVerseListenA11y: '이 구절 본문을 세 번 읽어 줍니다',
    verifyVerseListenPauseA11y: '말씀 듣기 일시정지',
    verifyVerseListenResumeA11y: '말씀 듣기 이어듣기',
