...
export const ko = {
  ...
  verses: {
    ...
    emptyBody: '첫 말씀을 등록하고 암송 훈련을 시작해 보세요.',
    emptyCta: '첫 말씀 추가하기 (+)',
    emptyCtaA11y: '첫 말씀 추가 화면 열기',
    edit: '수정',
    delete: '삭제',
    deleteTitle: '구절 삭제',
    ...
    keywordModalHint: '빈칸 퀴즈에서 가릴 핵심 단어예요. 본문 속 단어를 그대로 골라 주세요.',
    keywordPlaceholder: '쉼표(,)로 여러 개 · 본문에 나오는 말과 띄어쓰기까지 맞추세요',
    keywordSave: '저장',
    keywordClear: '비우기',
    keywordCancel: '취소',
    mnemonics: '연상기법',
    mnemonicsA11y: '{{ref}} 연상기법 아이디어 편집',
    mnemonicsModalTitle: '연상기법 관리',
    mnemonicsModalHint: '외우기 쉽도록 떠올릴 연상 장치예요. 첫 글자 잇기, 이미지 연상 등.',
    mnemonicsPlaceholder: '이 구절을 외우는 데 도움이 되는 연상 아이디어를 자유롭게 적어 보세요',
    mnemonicsSave: '저장',
    mnemonicsClear: '비우기',
    mnemonicsCancel: '취소',
    rema: '레마',
  ...
  seven: {
    ...
    verifyRemaBtn: '레마',
    verifyRemaA11y: '이 구절에 등록된 레마를 확인합니다.',
  ...
  quiz: {
    ...
    orderDragHint: '화살표(▲▼)로 문장 조각의 순서를 바꿉니다.',
    orderMoveUpA11y: '이 조각을 위로 이동',
    orderMoveDownA11y: '이 조각을 아래로 이동',
  },
  reference: {
    label: '참조',
  },
